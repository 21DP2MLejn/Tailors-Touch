    ...
    return (
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">Elevate your style with our curated collection.</p>
          </div>
          <div>
            <h3 className="text-xl font-light mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link href="/pages/nav/products" className="text-gray-400 hover:text-white transition duration-300">Shop</Link></li>
