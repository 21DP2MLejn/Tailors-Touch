        ...
        <main>
          ...
          <section className="relative h-[70vh] flex items-center justify-center">
            ...
            <div className="relative z-10 text-center text-accent">
              ...
              <Link href="/pages/nav/products" className="bg-white text-text py-2 px-6 rounded-md hover:bg-gray-100 transition duration-300">
                Shop Now
              </Link>
            </div>
          </section>
              ...
              {['Women', 'Men', 'Accessories'].map((category) => (
                  <div key={category} className="relative h-64 group overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <h3 className="text-accent text-2xl font-light">{category}</h3>
                    </div>
                  </div>
              ))}
            </div>
